...
- [_ExceptionLessFormatter_](../src/Monolog/Formatter/ExceptionLessFormatter.php): Used to format log records into ExceptionLess messages, only useful for the ExceptionLessHandler.
