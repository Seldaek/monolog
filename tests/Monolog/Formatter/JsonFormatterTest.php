...
class JsonFormatterTest extends TestCase
{
    ...
    private function formatExceptionFilePathWithLine(Throwable $exception) : string
    {
    ...
    private function formatException(Throwable $exception, string $previous = null) : string
    {
        $formattedException =
