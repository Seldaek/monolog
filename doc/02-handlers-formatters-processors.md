...
- [_ClosureContextProcessor_](https://github.com/Seldaek/monolog/blob/main/src/Monolog/Processor/ClosureContextProcessor.php): Generates a context by a `Closure` if the `Closure` is set as the only value in the context.
